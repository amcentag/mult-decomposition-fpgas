...
HD_PWD='C:/Users/amcen/Documents/capstone project vivado files/implemented-karatsuba-10dsp/karatsuba_demo/karatsuba_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_demo.tcl
