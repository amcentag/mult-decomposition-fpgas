...
HD_PWD='C:/Users/amcen/Documents/capstone project vivado files/implemented-karatsuba-10dsp/karatsuba_demo/karatsuba_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_demo.tcl -notrace
