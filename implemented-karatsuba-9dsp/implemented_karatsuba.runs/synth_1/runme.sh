...
HD_PWD='C:/Users/amcen/Documents/capstone project vivado files/implemented_karatsuba/implemented_karatsuba.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log karatmult_64x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source karatmult_64x64.tcl
