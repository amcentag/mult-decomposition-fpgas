...
HD_PWD='C:/Users/amcen/Documents/capstone project vivado files/implemented_karatsuba/implemented_karatsuba.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log karatmult_64x64.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source karatmult_64x64.tcl -notrace
