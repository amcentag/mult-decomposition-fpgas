...
HD_PWD='C:/Users/amcen/Documents/capstone project vivado files/implemented-toom-multiplier/implemented-toom-multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_64x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_64x64.tcl
