...
HD_PWD='C:/Users/amcen/Documents/capstone project vivado files/implemented-toom-multiplier/implemented-toom-multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_64x64.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_64x64.tcl -notrace
